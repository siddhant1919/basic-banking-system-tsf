  ...
  ?>
      ...
      <div class="container-fluid">
            ...
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img class="im" src="img/coinbank.jpg" class="img-fluid pt-2">
              </div>
            </div>
      ...
      <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);text-align:center;color:white;">
                © 2021 Copyright - Made by <strong>Siddhant</strong> :
                <a class="text-dark" href="https://internship.thesparksfoundation.info/" target="_blank" style="color:white;"> The Sparks
                    Foundation </a>
            </div>
            <!-- Copyright -->
        </footer>
